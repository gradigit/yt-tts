...
class TestMaxChunkWords:
    def test_max_chunk_words_one_forces_single_word_chunks(self):
        """max_chunk_words=1 prevents multi-word matches, forcing word-by-word chunking."""
        matches = {"hello world": True, "hello": True, "world": True}
    ...
    def test_max_chunk_words_three_limits_chunk_size(self):
        """max_chunk_words=3 prevents chunks longer than 3 words."""
        matches = {
            "the quick brown fox jumps": True,  # 5 words -- should be skipped
            "the quick brown": True,            # 3 words -- fits
            "fox jumps": True,                  # 2 words -- fits
            "the": True, "quick": True, "brown": True, "fox": True, "jumps": True,
        }
    ...
    def test_max_chunk_words_zero_allows_full_phrase_match(self):
        """max_chunk_words=0 means no limit — allows matching any length."""
        matches = {"the quick brown fox jumps": True}
